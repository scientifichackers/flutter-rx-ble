...
class RxBlePlugin(val registrar: Registrar) : MethodCallDispatcher(), PluginRegistry.ActivityResultListener,
    PluginRegistry.RequestPermissionsResultListener {

    companion object {
        @JvmStatic
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "rx_ble")
            channel.toString()
    ...
    fun isLocEnabled(callback: (Boolean, e: ResolvableApiException?) -> Unit) {
        ...
        val taskResult = LocationServices
